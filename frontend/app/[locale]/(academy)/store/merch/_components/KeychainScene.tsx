...
function TShirtWhiteModel({ scale }: { scale: number }) {
  const { scene } = useGLTF('/models/tshirt-white.glb')
  return (
...
useGLTF.preload('/models/tshirt-white.glb')
