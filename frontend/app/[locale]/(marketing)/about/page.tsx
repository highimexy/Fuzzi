        ...
        <Container className="">
          <div className="flex flex-col items-start lg:flex-row">
            ...
            <aside className="border-foreground/10 bg-foreground/2 sticky top-14 hidden w-64 shrink-0 flex-col border-b lg:flex lg:border-b">
              ...
              <nav className="flex flex-col">
                {sections.map((sec, index) => (
                  ...
                  >
                    <span className="text-foreground font-sans text-xs font-bold tracking-widest uppercase transition-colors group-hover:text-foreground/60">
                      {sec.label}
                    </span>
                  </a>
                ))}
            ...
            <div className="bg-foreground/10 border-foreground/10 flex w-full flex-1 flex-col border-l">
              ...
              >
                <h2 className="font-serif text-3xl tracking-tighter text-foreground/60 uppercase italic opacity-80">
                  {t('manifesto.title')}
                </h2>
              ...
              <div
                ...
                className="bg-background border-foreground/10 scroll-mt-32 border-b p-8 md:p-12 lg:p-16"
              >
                <h2 className="mb-12 font-serif text-3xl tracking-tighter text-foreground/60 uppercase italic opacity-80">
                  {t('faq.title')}
                </h2>
                  ...
                  {[1, 2, 3].map((num) => (
                    <div key={`q${num}`} className="group">
                      ...
                      <h3 className="text-foreground mb-4 font-sans text-sm font-bold tracking-widest uppercase">
                        <span className="mr-2 text-foreground/50 opacity-50">Q:</span>
                        {t(`faq.q${num}`)}
                      </h3>
                      <p className="ml-1 border-l border-foreground/20 pl-4 font-sans text-base leading-relaxed opacity-60">
                        {t(`faq.a${num}`)}
                      </p>
                    </div>
                  ))}
