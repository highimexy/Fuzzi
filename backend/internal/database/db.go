...
func Connect() {
	...
	err = DB.AutoMigrate(&models.Lesson{}, &models.LessonProgress{}, &models.Quest{}, &models.QuestAttempt{}, &models.UserQuestStats{}, &models.DiscussPost{}, &models.DiscussComment{}, &models.DiscussVote{})
	if err != nil {
